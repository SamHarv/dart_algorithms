class AvlNode<T> {
  ...
  void traverseInOrder(void Function(AvlNode<T> value) action) {
    leftChild?.traverseInOrder(action);
    action(this);
    rightChild?.traverseInOrder(action);
  }

  void traversePreOrder(void Function(AvlNode<T> value) action) {
    action(this);
    leftChild?.traversePreOrder(action);
    rightChild?.traversePreOrder(action);
  }

  void traversePostOrder(void Function(AvlNode<T> value) action) {
